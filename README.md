...
## Indice dei contenuti
 ...
 - [Cold Outreach Agent](notebooks/ai-agent-deep-web-researcher.ipynb) – Agente che pianifica ricerche web, sintetizza i risultati in un report strutturato, usando OpenAI Agents, tool hosted e tracing end-to-end..
